...
document.querySelectorAll("input[name='newTaxBand'], input[name='newTaxReg']").forEach(function(el) {
...
function calculate() {
    ...
    let useNewTaxBand = document.querySelector("input[name='newTaxBand']").checked;
    ...
    // If useNewTaxBand is checked, also checked useNewTaxReg
    if (useNewTaxReg) {
        ...
        useNewTaxBand = false;
        document.querySelector("input[name='newTaxBand']").checked = false;
    }
    if (useNewTaxBand) {
        useNewTaxReg = true;
        document.querySelector("input[name='newTaxReg']").checked = true;
